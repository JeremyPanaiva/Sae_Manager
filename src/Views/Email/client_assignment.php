    ...
    <body style='font-family: Arial, sans-serif; line-height: 1.6; color: #333;'>
        <div style='max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f9f9f9;'>
            ...
            border-radius: 5px 5px 0 0; margin: -30px -30px 20px -30px;'>
                ...
                <p>Nous vous informons qu'un étudiant a été affecté à votre SAE par le responsable
                    <strong><?= $RESPONSABLE_NAME ?></strong>.
                </p>
        ...
        margin: 20px 0; border-left: 4px solid #2196F3;'>
                    ...
                    <p style='color: #555; margin: 10px 0;'>
                        <strong>🎓 Étudiant affecté :</strong> <?= $STUDENT_NAME ?>
                    </p>
                    <p style='color: #555; margin: 10px 0;'>
                        <strong>👨‍🏫 Responsable :</strong> <?= $RESPONSABLE_NAME ?>
                    </p>
                </div>
