...
<body style='font-family: Arial, sans-serif; line-height: 1.6; color: #333;'>
    <div style='max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f9f9f9;'>
        ...
        margin: 20px 0; border-left: 4px solid #4CAF50;'>
                ...
                <p style='color: #555; margin: 5px 0;'><strong>👨‍🏫 Responsable :</strong>
                    <?php echo $RESPONSABLE_NAME; ?></p>
                <p style='color: #555; margin: 5px 0;'><strong>📅 Date de rendu :</strong> <?php echo $DATE_RENDU; ?>
                </p>
            </div>
