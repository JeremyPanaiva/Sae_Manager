    ...
    <fieldset>
      ...
      <div class="password-wrapper">
        <input type="password" id="mdp" name="mdp" required minlength="12" maxlength="30"
          ...
          title="Le mot de passe doit contenir entre 12 et 30 caractères, une majuscule, une minuscule, un chiffre et un caractère spécial"
      ...
      <small style="color: #6c757d; font-size: 0.85rem; margin-top: -0.5rem;">
        Le mot de passe doit contenir entre 12 et 30 caractères avec une majuscule, une minuscule, un chiffre et un caractère spécial.
      </small>
