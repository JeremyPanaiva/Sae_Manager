        ...
        <fieldset>
            ...
            <div class="password-wrapper">
                <input type="password" id="password" name="password" minlength="12" maxlength="30"
                    ...
                    title="Le mot de passe doit contenir entre 12 et 30 caractères, une majuscule,
                    une minuscule, un chiffre et l'un de ces caractères spéciaux :
                    ! @ # $ % ^ & * ( ) _ + € £ µ § ? / \\ | { } [ ]" required
            ...
            <small style="display:block; margin-bottom:15px; color:#666; font-size:0.9em;">
                Minimum 12 caractères avec au moins une majuscule, une minuscule, un chiffre et l'un
                de ces caractères spéciaux : ! @ # $ % ^ & * ( ) _ + € £ µ § ? / \ | { } [ ]
            </small>
