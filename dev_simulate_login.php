<?php
// Dev helper: simulate a logged-in session for a given user id and token.
// WARNING: For development/testing only. Remove this file in production.
...
if ($userId === null) {
    echo "Usage: dev_simulate_login.php?user_id=<id>&token=<token>\n";
    exit;
}
